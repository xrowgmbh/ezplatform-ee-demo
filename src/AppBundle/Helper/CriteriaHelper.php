...
{
    /**
     * Generate criterion to fetch folder's children.
     *
     * @param \eZ\Publish\API\Repository\Values\Content\Content $content Location of the folder
     ...
     */
    public function generateListFolderCriterion(Content $content, array $excludeContentTypeIdentifiers = array(), array $languages = array())
    {
        $criteria = array();
        $criteria[] = new Criterion\Visibility(Criterion\Visibility::VISIBLE);
        $criteria[] = new Criterion\ParentLocationId($content->contentInfo->mainLocationId);
    ...
    /**
     * Generate criterion to list sub folder items.
     *
     * @param \eZ\Publish\API\Repository\Values\Content\Content $content Location of the folder
     ...
     * @return \eZ\Publish\API\Repository\Values\Content\Query\Criterion
     */
    public function generateSubContentCriterion(Content $content, array $includedContentTypeIdentifiers = array(), array $languages = array())
    {
        $criteria = array();
        $criteria[] = new Criterion\Visibility(Criterion\Visibility::VISIBLE);
